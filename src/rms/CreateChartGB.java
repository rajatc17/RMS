 ...
 * @author rajat
 */
public class CreateChartGB implements Connectivity{
    ...
    public CreateChartGB(String title,JPanel parent)
    {
    ...
    public void init_icodes()
    {
        ...
        { 
            ...
            PreparedStatement ps=cn.prepareStatement("select ICode,QTY,Description from orderdetails where Type='GB'");
