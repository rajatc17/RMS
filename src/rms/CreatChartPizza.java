 ...
 * @author rajat
 */
public class CreatChartPizza implements Connectivity{
    ...
    public CreatChartPizza(String title,JPanel parent)
    {
    ...
    public void init_icodes()
    {
        ...
        { 
            ...
            PreparedStatement ps=cn.prepareStatement("select ICode,QTY,Description from orderdetails where Type='Pizza'");
